...
export const I18N = {
  no: {
    ...
    assignTitle: 'Tildel til løpere', racesForAthlete: 'Lagets renn', travelAndCost: 'Reiser og kostnad',
  ...
  en: {
    ...
    assignTitle: 'Assign to athletes', racesForAthlete: 'Team races', travelAndCost: 'Travel and cost',
